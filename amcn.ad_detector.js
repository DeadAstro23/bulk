$pdk.ns("$pdk.plugin.amcn.ad_detector");
$pdk.plugin.amcn.AdDetector = $pdk.extend(function() {}, {
    initialize: function(loadObj) {
		...
		if (loadObj.vars && loadObj.vars["hosts"]) {
        	...
        	tpDebug("*** adDetector plugin LOADED! ***");
    },
    isAd: function(clip) {
...
var adDetectorPlugin = new $pdk.plugin.amcn.AdDetector();
$pdk.controller.plugInLoaded(adDetectorPlugin);